...
function jMaint() {
  ...
  const jpActive = new Date("May 22, 2024 10:00:00 GMT+09:00").getTime(),
    jpEnd = new Date("May 22, 2024 17:00:00 GMT+09:00").getTime(),
...
function gMaint() {
  ...
  const glActive = new Date("May 9, 2024 02:30:00 GMT+00:00").getTime(),
    glEnd = new Date("May 9, 2024 06:30:00 GMT+00:00").getTime(),
