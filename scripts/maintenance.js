...
function jMaint() {
  ...
  const jpActive = new Date("June 12, 2024 12:00:00 GMT+09:00").getTime(),
    jpEnd = new Date("June 12, 2024 17:00:00 GMT+09:00").getTime(),
...
function gMaint() {
  ...
  const glActive = new Date("June 12, 2024 02:30:00 GMT+00:00").getTime(),
    glEnd = new Date("June 12, 2024 06:30:00 GMT+00:00").getTime(),
