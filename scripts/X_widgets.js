// improved timeline javascript from https://platform.twitter.com/widgets.js to adhere with the X branding
// some functions/elements remain unchanged
    ...
    (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
      (function (t) {
        ...
        function (t, e, n) {
          var r = n(16),
            i =
              /(?:^|(?:https?:)?\/\/(?:www\.)?x\.com(?::\d+)?(?:\/intent\/(?:follow|user)\/?\?screen_name=|(?:\/#!)?\/))@?([\w]+)(?:\?|&|$)/i,
            o =
              /(?:^|(?:https?:)?\/\/(?:www\.)?x\.com(?::\d+)?\/(?:#!\/)?[\w_]+\/status(?:es)?\/)(\d+)/i,
            s = /^http(s?):\/\/(\w+\.)*x\.com([:/]|$)/i,
            a = /^http(s?):\/\/(ton|pbs)\.twimg\.com/,
            u = /^#?([^.,<>!\s/#\-()'"]+)$/,
            c = /x\.com(?::\d{2,4})?\/intent\/(\w+)/,
            d = /^https?:\/\/(?:www\.)?x\.com\/\w+\/timelines\/(\d+)/i,
            f = /^https?:\/\/(?:www\.)?x\.com\/i\/moments\/(\d+)/i,
            l =
              /^https?:\/\/(?:www\.)?x\.com\/(\w+)\/(?:likes|favorites)/i,
            h = /^https?:\/\/(?:www\.)?x\.com\/(\w+)\/lists\/([\w-%]+)/i,
            p = /^https?:\/\/(?:www\.)?x\.com\/i\/live\/(\d+)/i,
            m = /^https?:\/\/syndication\.x\.com\/settings/i,
            v =
              /^https?:\/\/(localhost|platform)\.x\.com(?::\d+)?\/widgets\/widget_iframe\.(.+)/i,
            g = /^https?:\/\/(?:www\.)?x\.com\/search\?q=(\w+)/i;
          function w(t) {
          ...
          function b(t, e) {
            ...
            if (((e = e || !1), (n.screen_name = y(t)), n.screen_name))
              return r.url(
                "https://x.com/intent/" + (e ? "follow" : "user"),
                n
              );
          }
          function _(t) {
        ...
        function (t, e, n) {
          var r = n(9),
            i = n(102),
            o = "https://syndication.x.com",
            s = "https://platform.x.com",
            a = [
              "https://syndication.x.com",
              "https://cdn.syndication.twimg.com",
              "https://localhost.x.com:8444",
            ],
            u = [
              "https://syndication.x.com",
              "https://localhost.x.com:8445",
            ],
            c = [
              "https://platform.x.com",
              "https://localhost.x.com",
              /^https:\/\/ton\.local\.x\.com\/syndication-internal\/embed-iframe\/[0-9A-Za-z_-]+\/app/,
            ],
            d = function (t, e) {
        ...
        function (t, e, n) {
          ...
          t.exports = {
            ...
            RUFOUS_REDIRECT: "https://platform.x.com/jot.html",
          };
        },
        function (t, e, n) {
          var r = n(8),
        ...
        function (t, e, n) {
          ...
          t.exports = function () {
            r.publicError(
              ...
              "https://devcommunity.x.com/t/removing-support-for-embedded-like-collection-and-moment-timelines/150313 \n\t",
              "* In order to create a new Embedded Timeline, visit: https://publish.x.com"
            );
          };
        },
        function (t, e, n) {
        ...
        function (t) {
          t.exports = {
            ...
            resourceBaseUrl: "https://platform.x.com",
          };
        },
        function (t, e, n) {
          var r = n(4),
        ...
        function (t, e, n) {
          var r = n(5),
            ...
            l =
              "Embedded Search timelines have been deprecated. See https://devcommunity.x.com/t/deprecating-widget-settings/102295.",
            h =
              "You may have been affected by an update to settings in embedded timelines. See https://devcommunity.x.com/t/deprecating-widget-settings/102295.",
            p =
              "Embedded grids have been deprecated and will now render as timelines. Please update your embed code to use the twitter-timeline class. More info: https://devcommunity.x.com/t/update-on-the-embedded-grid-display-type/119564.";
          t.exports = function (t, e) {
        ...
        function (t, e, n) {
          var r = n(8),
            ...
            f = n(6),
            l =
              "Embedded grids have been deprecated. Please use twttr.widgets.createTimeline instead. More info: https://devcommunity.x.com/t/update-on-the-embedded-grid-display-type/119564.",
            h = {
              createTimeline: p,
          ...
          function p(t) {
            ...
            return a.isString(t) || a.isNumber(t)
              ? f.reject(
                  "Embedded timelines with widget settings have been deprecated. See https://devcommunity.x.com/t/deprecating-widget-settings/102295."
                )
              : s.isObject(t)
              ? ((t = t || {}),
                n.forEach(function (t) {
