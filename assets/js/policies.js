function fetchDate(mt, dd, yy, hh, mm, tz) {
  ...
  document.querySelector("#policyDate-en").innerHTML = `${upd.getDate()} ${monthDef(upd.getMonth())} ${upd.getFullYear()}&ensp;&#8226;&ensp;${hr12(upd.getHours())}:${addZero(upd.getMinutes())}${ampm(upd.getHours())} VIT`;
}
