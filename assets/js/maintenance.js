...
function jpMaint(sMt, sDy, sHh, sMm, eMt, eDy, eHh, eMm, tzz) {
  ...
  document.getElementById("impt-ja_jp").innerHTML = "32番目の全体的なヴィーナスのデビュー";
  document.getElementById("impt-en_jp").innerHTML = "Debut of the 32nd Overall Venus";
...
function viewMaintenance(id, edition) {
  switch (edition) {
    case "ja":
      return window.open(`https://doax-venusvacation.jp/${id}.html`, "_blank");
    case "gl":
      return window.open(`https://game.doaxvv.com/production/html/information/${id}.html`, "_blank");
    default: return this.preventDefault();
  }
}