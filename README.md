_Updated 18 April 2022 Venus Island Time (UTC)_
...
Yes! Our web presence, being on an open-source platform, is licensed under **Creative Commons Zero (CC0) 1.0 Universal**, which can be read via this [file](http://github.com/MamaNyoSquad/mamanyosquad.github.io/blob/main/LICENSE.md) (this change has been in effect via this [commit](http://github.com/MamaNyoSquad/mamanyosquad.github.io/commit/cf6f42377dde718495347c419f10a1f736862aae)).

# Are the Site Policies still in effect?
_Enforced 30 March 2022 Venus Island Time (UTC)_

They still are! The only issue is, due to migration purposes, they are situated here for the time being. Few commits might include a dedicated page for it (along with new and existing stuff)! The Site Policies are as follows:

## Cookies
We use cookies to **improve your experience and to give us analysis on the Site's performance, excluding marketing purposes**. By continuing to use this Site you are agreeing to such cookies.

Some cookies may be **attached by the providers as we use their services**. Their respective Policies apply.

## Content Moderation
We moderate our content thoroughly to **avoid any sensitive content**. We will notify everyone if a content falls under such category.

Most content shown are PG. **Parental Guidance is advised.**

## Usage of Content from Other Sources
Beginning 9 December 2021, we are **supplying every required information when we use media from other sources and creators**, excluding the ones we supplied in-house. **This is to avoid any further infringement of related content under any circumstances.**

**Most content is supplied by KOEI TECMO GAMES Co., Ltd.** Read on for the KT Disclosure.

## Hosting Provider Policy
Learn more about how GitHub collects and processes information via this [documentation](http://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement).

# KT Disclosure
_Enforced 20 July 2021 Venus Island Time (UTC)_

This information contains some general information and enforcing mechanisms regarding content originated from KOEI TECMO GAMES (and KT Holdings).

## Introduction
#MamaNyoSquad is a community-based, non-incorporating organization managed or operated by an individual or two that makes use of assets from other sources.

We understood the risk of some assets being classified as non-distributable materials, and we govern that the assets are handled with integrity in mind.

## Handling the Assets
Most of the assets that are displayed on this website are not our sole property, therefore it's our responsibility to handle them without causing any harm to the parties involved.

The way we handle the assets may depend on the situation given: Either we display the assets, disclosing the attribution from another source or property; or make our own rendition of existing assets given the amount of time allotted before the display of such assets.

We may also acquire additional assets that may not have been disclosed to the public before a specific date. As such, we will apply a disclaimer and/or additional security measures given as part of our handling measures.

## Properties
We are complying with the best we can to ensure no damages have been warranted against the use of such assets.

We may be prompted to remove the assets and/or take down if they deem we violated their properties, with or without question. In case of infringement, please contact us by Email or Twitter DM.

We may also send them a formal permission to use the assets as long as such are not violated under such properties. Failure to do so, when prompted however, may result in what cited on paragraph two.

As such, we may resort to citing attributions and/or disclaimers for the meantime. See section "Handling the Assets" for information.

## Additional Information
We may garner additional information that may or may not be related to the overall subject matter, such as news and social information.

As such, we may classify such information, although some may be moved to a different channel because of urgent reasons.

We may be using the assets in order to depict the information given. See section "HOW WE HANDLE THE ASSETS" for information. For intellectual properties, see "Properties" section.

## Conclusion
Such assets that we displayed on this website are by no means our property, and we will take responibility for any damages given by such liabilities. NO COPYRIGHT INFRINGEMENT INTENDED.
